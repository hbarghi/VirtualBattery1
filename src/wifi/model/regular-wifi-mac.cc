...
void
RegularWifiMac::SetGamma(double Gamma, double TotalSimulationTime)
{
  m_low->SetGamma (Gamma,TotalSimulationTime);
}
double
RegularWifiMac::GetRemEnergy ()
{
  return m_low->GetRemEnergy ();
}
