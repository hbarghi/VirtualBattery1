...
{ 
  ...
  pos=Vector(0,180,0);
  nodes.Get (4)->GetObject<MobilityModel>()->SetPosition (pos);
  pos=Vector(90,180,0);
  nodes.Get (5)->GetObject<MobilityModel>()->SetPosition (pos);
  pos=Vector(180,90,0);
  nodes.Get (6)->GetObject<MobilityModel>()->SetPosition (pos);
  pos=Vector(270,0,0);
  nodes.Get (7)->GetObject<MobilityModel>()->SetPosition (pos);
  pos=Vector(360,0,0);
  nodes.Get (8)->GetObject<MobilityModel>()->SetPosition (pos);
  pos=Vector(450,0,0);
  nodes.Get (9)->GetObject<MobilityModel>()->SetPosition (pos);
  pos=Vector(270,90,0);
  nodes.Get (10)->GetObject<MobilityModel>()->SetPosition (pos);
  pos=Vector(360,90,0);
  nodes.Get (11)->GetObject<MobilityModel>()->SetPosition (pos);
  pos=Vector(450,90,0);
  nodes.Get (12)->GetObject<MobilityModel>()->SetPosition (pos);
  pos=Vector(270,180,0);
  nodes.Get (13)->GetObject<MobilityModel>()->SetPosition (pos);
  pos=Vector(360,180,0);
  nodes.Get (14)->GetObject<MobilityModel>()->SetPosition (pos);
  pos=Vector(450,180,0);
  nodes.Get (15)->GetObject<MobilityModel>()->SetPosition (pos);
